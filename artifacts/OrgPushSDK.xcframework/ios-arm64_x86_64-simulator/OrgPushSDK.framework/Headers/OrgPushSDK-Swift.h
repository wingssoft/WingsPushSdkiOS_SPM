...
#ifndef ORGPUSHSDK_SWIFT_H
#define ORGPUSHSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OrgPushSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC10OrgPushSDK13BaseApiResult")
...
SWIFT_CLASS("_TtC10OrgPushSDK21ContentDownloadResult")
...
SWIFT_PROTOCOL("_TtP10OrgPushSDK20ExtraContentProtocol_")
...
SWIFT_PROTOCOL("_TtP10OrgPushSDK34HttpRequestAdditionalHeaderManager_")
...
SWIFT_PROTOCOL("_TtP10OrgPushSDK15MessageProtocol_")
...
@property (nonatomic, readonly, copy) NSString * _Nullable messageStringDate;
/// Available Content
...
SWIFT_CLASS("_TtC10OrgPushSDK14MessagesResult")
...
SWIFT_CLASS("_TtC10OrgPushSDK16MessagesV2Result")
@interface MessagesV2Result : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC10OrgPushSDK7PushSDK")
...
SWIFT_CLASS("_TtC10OrgPushSDK16StatisticsResult")
...
SWIFT_CLASS("_TtC10OrgPushSDK19SubscriberGetResult")
...
@interface UIApplication (SWIFT_EXTENSION(OrgPushSDK))
...
SWIFT_CLASS("_TtC10OrgPushSDK11UUIDManager")
...
SWIFT_CLASS("_TtC10OrgPushSDK8Watchdog")
